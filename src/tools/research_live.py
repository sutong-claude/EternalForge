...
_SPECS: list[tuple[tuple[str, ...], str, str]] = [
    ...
    (("oalocholinames", "locholinames-oa", "works-locholinames-oa"), "oalocholinames", "OaLocHoLinamesAdapter"),
    (("oalocdname", "locdname-oa", "works-locdname-oa"), "oalocdname", "OaLocDnameAdapter"),
    (("oaauthcc", "authcc-oa", "works-authcc-oa"), "oaauthcc", "OaAuthCcAdapter"),
    (("oaauthtype", "authtype-oa", "works-authtype-oa"), "oaauthtype", "OaAuthTypeAdapter"),
    (("oaauthid", "authid-oa", "works-authid-oa"), "oaauthid", "OaAuthIdAdapter"),
    (("oaauthror", "authror-oa", "works-authror-oa"), "oaauthror", "OaAuthRorAdapter"),
    (("oaauthdname", "authdname-oa", "works-authdname-oa"), "oaauthdname", "OaAuthDnameAdapter"),
    (("oaauthlin", "authlin-oa", "works-authlin-oa"), "oaauthlin", "OaAuthLinAdapter"),
    ...
    (("oaauthorcorr", "authorcorr-oa", "works-authorcorr-oa"), "oaauthorcorr", "OaAuthorCorrAdapter"),
    (("oaauthoraffil", "authoraffil-oa", "works-authoraffil-oa"), "oaauthoraffil", "OaAuthorAffilAdapter"),
    (("oaauthorpos", "authorpos-oa", "works-authorpos-oa"), "oaauthorpos", "OaAuthorPosAdapter"),
    (("oaauthoraffils", "authoraffils-oa", "works-authoraffils-oa"), "oaauthoraffils", "OaAuthorAffilsAdapter"),
    (("oaauthorname", "authorname-oa", "works-authorname-oa"), "oaauthorname", "OaAuthorNameAdapter"),
    (("oacorrids", "corrids-oa", "works-corrids-oa"), "oacorrids", "OaCorrIdsAdapter"),
    (("oacorrinst", "corrinst-oa", "works-corrinst-oa"), "oacorrinst", "OaCorrInstAdapter"),
    ...
    (("oaidsopenalex", "idsoa-oa", "works-idsoa-oa"), "oaidsopenalex", "OaIdsOpenalexAdapter"),
    (("oaidswikidata", "idswd-oa", "works-idswd-oa"), "oaidswikidata", "OaIdsWikidataAdapter"),
    (("oarefs", "refs-oa", "works-refs-oa"), "oarefs", "OaRefsAdapter"),
    (("oarelated", "related-oa", "works-related-oa"), "oarelated", "OaRelatedAdapter"),
    (("oasdgs", "sdgs-oa", "works-sdgs-oa"), "oasdgs", "OaSdgsAdapter"),
    (("oagrants", "grants-oa", "works-grants-oa"), "oagrants", "OaGrantsAdapter"),
    (("oatopicid", "topicid-oa", "works-topicid-oa"), "oatopicid", "OaTopicIdAdapter"),
    (("oaaward", "award-oa", "works-award-oa"), "oaaward", "OaAwardAdapter"),
    (("oatsfield", "subfield-oa", "works-subfield-oa"), "oatsfield", "OaTsFieldAdapter"),
    (("oatfield", "field-oa", "works-field-oa"), "oatfield", "OaTFieldAdapter"),
    (("oatdomain", "domain-oa", "works-domain-oa"), "oatdomain", "OaTDomainAdapter"),
    (("oaprtopic", "prtopic-oa", "works-prtopic-oa"), "oaprtopic", "OaPrTopicAdapter"),
    (("oakw", "keywords-oa", "works-keywords-oa"), "oakw", "OaKwAdapter"),
    (("oakwid", "kwid-oa", "works-kwid-oa"), "oakwid", "OaKwIdAdapter"),
    (("oaconcid", "concid-oa", "works-concid-oa"), "oaconcid", "OaConcIdAdapter"),
    (("oaconclev", "conclev-oa", "works-conclev-oa"), "oaconclev", "OaConcLevAdapter"),
    (("oakwdn", "kwdn-oa", "works-kwdn-oa"), "oakwdn", "OaKwDnAdapter"),
    (("oaconcwd", "concwd-oa", "works-concwd-oa"), "oaconcwd", "OaConcWdAdapter"),
    (("oaconcdn", "concdn-oa", "works-concdn-oa"), "oaconcdn", "OaConcDnAdapter"),
]
