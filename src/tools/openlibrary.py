...
from tools.oahasabs import OaHasAbsAdapter
from tools.oahasaffil import OaHasAffilAdapter
...
from tools.oahasobronze import OaHasOaBronzeAdapter
from tools.oahasodiamond import OaHasOaDiamondAdapter
from tools.oahasogold import OaHasOaGoldAdapter
from tools.oahasogreen import OaHasOaGreenAdapter
from tools.oahasoahybrid import OaHasOaHybridAdapter
from tools.oahasoanyrepo import OaHasOaAnyRepoAdapter
...
from tools.oahasoaalic import OaHasOaLicAdapter
from tools.oahasoaalicid import OaHasOaLicIdAdapter
...
from tools.oabestsrcid import OaBestSrcIdAdapter
from tools.oabestsrctype import OaBestSrcTypeAdapter
from tools.oabestissn import OaBestIssnAdapter
from tools.oabesthost import OaBestHostAdapter
from tools.oabesthoname import OaBestHoNameAdapter
from tools.oabestholineage import OaBestHoLineageAdapter
...
class MultiAdapter:
    ...
    def __init__(
        ...
        self.adapters = adapters or [
            ...
            OaHasPmidAdapter(timeout=timeout),
            OaHasPmcidAdapter(timeout=timeout),
            OaHasIssnAdapter(timeout=timeout),
            OaHasOrcidAdapter(timeout=timeout),
            ...
            OaHasOaGoldAdapter(timeout=timeout),
            OaHasOaHybridAdapter(timeout=timeout),
            ...
            OaHasOaAnyRepoAdapter(timeout=timeout),
            OaHasOaPubAdapter(timeout=timeout),
            ...
            OaHasOaLicAdapter(timeout=timeout),
            OaHasOaLicIdAdapter(timeout=timeout),
            ...
            OaBestSrcIdAdapter(timeout=timeout),
            OaBestSrcTypeAdapter(timeout=timeout),
            OaBestIssnAdapter(timeout=timeout),
            OaBestHostAdapter(timeout=timeout),
            OaBestHoNameAdapter(timeout=timeout),
            OaBestHoLineageAdapter(timeout=timeout),
        ]
