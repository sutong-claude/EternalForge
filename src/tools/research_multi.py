...
_MULTI: list[tuple[str, str]] = [
    ...
    (("oahasoaalic", "OaHasOaLicAdapter") if False else ("oahasoaalic", "OaHasOaLicAdapter")),
    ...
    ("oaauthorpos", "OaAuthorPosAdapter"),
    ("oaauthoraffils", "OaAuthorAffilsAdapter"),
    ("oaauthorname", "OaAuthorNameAdapter"),
    ("oacorrids", "OaCorrIdsAdapter"),
    ...
    ("oarelated", "OaRelatedAdapter"),
    ("oasdgs", "OaSdgsAdapter"),
    ("oagrants", "OaGrantsAdapter"),
    ("oatopicid", "OaTopicIdAdapter"),
    ("oaaward", "OaAwardAdapter"),
    ("oatsfield", "OaTsFieldAdapter"),
    ("oatfield", "OaTFieldAdapter"),
    ("oatdomain", "OaTDomainAdapter"),
    ("oaprtopic", "OaPrTopicAdapter"),
    ("oakw", "OaKwAdapter"),
    ("oakwid", "OaKwIdAdapter"),
    ("oaconcid", "OaConcIdAdapter"),
    ("oaconclev", "OaConcLevAdapter"),
    ("oakwdn", "OaKwDnAdapter"),
]
