...
**Last updated:** 2026-09-24 04:18 UTC
...
3. Optional next live SearchAdapter (another no-key extras slice) if a better increment than another split. Consider topics.keywords or primary_topic.id.
