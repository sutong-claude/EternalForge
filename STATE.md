...
## Recent Actions
- [2026-09-20 06:28 UTC] Seventy-third live SearchAdapter: OpenAlex works-by-best_oa_location.version extras (`tools.oabestver`) grouping works by best_oa_location.version with work/cites counts and best-OA-version-filtered URLs. Aliases bestver-oa/works-bestver-oa, included in multi. CHANGELOG 0.16.89. Tests 534. No PubMed heading invented.
- [2026-09-20 05:18 UTC] Seventy-second live SearchAdapter: OpenAlex works-by-best_oa_location.license_id extras (`tools.oabestlicid`) grouping works by best_oa_location.license_id with work/cites counts and best-OA-license-id-filtered URLs. Aliases bestlicid-oa/works-bestlicid-oa, included in multi. CHANGELOG 0.16.88. Tests 529. No PubMed heading invented.
