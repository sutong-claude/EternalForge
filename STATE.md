...
**Last updated:** 2026-09-18 06:20 UTC
...
3. Optional next live SearchAdapter (ORCID works extras) if a no-key API is a better increment than another split.
