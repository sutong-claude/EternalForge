...
**Last updated:** 2026-09-24 02:20 UTC
...
3. Optional next live SearchAdapter (another no-key extras slice) if a better increment than another split. Consider topics.field.id or topics.domain.id.
