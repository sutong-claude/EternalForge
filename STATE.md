...
**Last updated:** 2026-09-14 20:05 UTC
...
1. Harden STATE progress parser (duplicate try-blocks)
2. Surface recent journal kinds in `eternalforge status`
3. Add a third live SearchAdapter or merge-hits multi-backend search
