...
- [2026-09-20 17:10 UTC] Eighty-third live SearchAdapter: OpenAlex works-by-best_oa_location.source.is_core extras (`tools.oabestcore`) grouping works by best_oa_location.source.is_core with work/cites counts and best-OA-source-core-filtered URLs. Aliases bestcore-oa/works-bestcore-oa, included in multi. CHANGELOG 0.16.99. Tests 584. No PubMed heading invented.
