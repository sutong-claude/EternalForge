...
**Last updated:** 2026-09-24 06:27 UTC
...
3. Optional next live SearchAdapter (another no-key extras slice) if a better increment than another split. Consider keywords.id or concepts.id.
